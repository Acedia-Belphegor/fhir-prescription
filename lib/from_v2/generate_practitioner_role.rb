...
class GeneratePractitionerRole < GenerateAbstract
    def perform()
        ...
        practitioner_role.specialty << orc_segment[:entering_organization].map{|element|generate_codeable_concept(element)} if orc_segment[:entering_organization].present?
