...
class SipsGenerateOrganization < SipsGenerateAbstract
    ...
    def generate_medical_institution_resource()
        ...
        organization.identifier << build_identifier(prescription_record[:medical_institution_prefecture_code], 'urn:oid:1.2.392.100495.20.3.21')
        organization.identifier << build_identifier(tensuhyo, 'urn:oid:1.2.392.100495.20.3.22')
        organization.identifier << build_identifier(prescription_record[:medical_institution_receipt_code], 'urn:oid:1.2.392.100495.20.3.23')
        organization.name = prescription_record[:medical_institution_name]
        organization.type << build_codeable_concept('prov', 'Healthcare Provider', 'http://hl7.org/fhir/ValueSet/organization-type')
        ...
        if prescription_record[:department_code].present?
            ...
            organization.identifier << build_identifier(prescription_record[:department_code], 'LC')
            organization.name = prescription_record[:department_name]
            organization.type << build_codeable_concept('dept', 'Hospital Department', 'http://hl7.org/fhir/ValueSet/organization-type')
    ...
    def generate_pharmacy_resource()
        ...
        organization.identifier << build_identifier(header_record[:prefecture_code], 'urn:oid:1.2.392.100495.20.3.21')
        organization.identifier << build_identifier(header_record[:tensuhyo], 'urn:oid:1.2.392.100495.20.3.22')
        organization.identifier << build_identifier(header_record[:pharmacy_code], 'urn:oid:1.2.392.100495.20.3.23')
